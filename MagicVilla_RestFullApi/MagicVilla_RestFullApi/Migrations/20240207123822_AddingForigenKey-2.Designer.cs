...
namespace MagicVillaRestFullApi.Migrations
{
    ...
    [Migration("20240207123822_AddingForigenKey-2")]
    partial class AddingForigenKey2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MagicVilla_RestFullApi.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreateDate = new DateTime(2024, 2, 7, 18, 8, 21, 963, DateTimeKind.Local).AddTicks(8963),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreateDate = new DateTime(2024, 2, 7, 18, 8, 21, 963, DateTimeKind.Local).AddTicks(8985),
                            Details = "Cool Villa",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreateDate = new DateTime(2024, 2, 7, 18, 8, 21, 963, DateTimeKind.Local).AddTicks(8989),
                            Details = "Nice  Villa",
